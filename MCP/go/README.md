# Backup and DR Service API MCP Server

This MCP (Model Content Protocol) server provides access to Backup and DR Service API API functionality through HTTP, HTTPS, and STDIO transport modes.
