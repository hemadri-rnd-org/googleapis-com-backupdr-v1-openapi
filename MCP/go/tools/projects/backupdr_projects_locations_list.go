...
func Backupdr_projects_locations_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/%s/locations%s", cfg.BaseURL, name, queryString)
...
func CreateBackupdr_projects_locations_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_name_locations",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Backupdr_projects_locations_listHandler(cfg),
	}
}
