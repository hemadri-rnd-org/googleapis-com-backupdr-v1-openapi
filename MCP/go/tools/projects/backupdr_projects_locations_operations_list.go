...
func Backupdr_projects_locations_operations_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateBackupdr_projects_locations_operations_listTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Backupdr_projects_locations_operations_listHandler(cfg),
	}
}
