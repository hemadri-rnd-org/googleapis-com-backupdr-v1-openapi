...
func Backupdr_projects_locations_managementservers_setiampolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/%s:setIamPolicy%s", cfg.BaseURL, resource, queryString)
...
func CreateBackupdr_projects_locations_managementservers_setiampolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_resource_setIamPolicy",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Backupdr_projects_locations_managementservers_setiampolicyHandler(cfg),
	}
}
